...
export default function FileInput({onInputChange, imageUploaded, onDrop}: FileInputProps) {
    ...
    return (
        <div
            className="flex bg-[#1F316F] justify-center items-center flex-col gap-4 border-[#454545] border-4 border-dashed mb-5 md:mb-0 md:h-96 md:w-96 h-80 w-80 rounded-xl"
            onDrop={onDrop}
